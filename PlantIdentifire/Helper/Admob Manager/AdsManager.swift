...
class AdsManager: NSObject {
    ...
    func loadInterstitialAd(){
        ...
        GADInterstitialAd.load(withAdUnitID: GOOGLE_ADS.InterstitialAds, request: request) { [self] (ad, error) in
            if error != nil {
    ...
    func createAndLoadNativeAds(numberOfAds: Int) {
        ...
        adLoader = GADAdLoader(adUnitID: GOOGLE_ADS.NativeAds, rootViewController: topMostViewController,
    ...
    func requestAppOpenAd() {
        ...
        if appOpenAd == nil{
            GADAppOpenAd.load(
                withAdUnitID: GOOGLE_ADS.OpenAds,
                request: GADRequest(),
...
class GoogleBannerAds: NSObject, GADBannerViewDelegate {
    ...
    func loadAds(vc: UIViewController, view : GADBannerView) {
        ...
        self.view.adUnitID = GOOGLE_ADS.BannerAds
...
class GoogleNativeAds: NSObject, GADNativeAdLoaderDelegate {
    ...
    func loadAds(_ vc: UIViewController, _ completion: @escaping (GADNativeAd) -> Void) {
        ...
        if NATIVE_ADS == nil{
            ...
            self.adLoader = GADAdLoader(adUnitID: GOOGLE_ADS.NativeAds, rootViewController: vc, adTypes: [GADAdLoaderAdType.native], options: [multipleAdsOptions])
